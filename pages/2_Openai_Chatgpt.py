...
with st.expander("Description and Features"):
    st.write("""
        OpenAI's ChatGPT software read by Python in a Streamlit UI.
        Two different examples are below. The main difference is where the directions for the chatbot originate.
        ...
        2nd- from within the OpenAI assistant creator.
    """)
...
with st.expander("Assistant created within Streamlit"):
    ...
    prompt = st.text_input("How's it hanging?", key="prompt")
    if prompt:
